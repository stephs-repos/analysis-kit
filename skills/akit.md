...
| `/akit-fill` | Once after you've dropped reference materials. Fills the six setup markers — `memory/project_overview.md` first (the single source for project context), then its CLAUDE.md/README distillations, stakeholder stance, seed caveats, and the data-profile inventory. |
