...
The difference between masked and unmasked aggregates is what makes this fixture useful — it lets tests verify that `data_contract.filters` is actually applied during replay.
