...
3. Have its filters declared in the entry's data_contract.
...
def median_session_rating(df: pd.DataFrame) -> float:
    ...
    filters declared in data_contract.filters before calling this.
    """
...
def main() -> None:
    ...
    # validate.py replays this independently using data_contract.
